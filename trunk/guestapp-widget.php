...
class GuestApp_Widget extends WP_Widget {
    ...
    private function build_reviews($json, $params = array()) {
        ...
        foreach ($data->data as $review) {
            $out .= render('templates/widget.php', array(
                "review" => $ga->getCleanReview($review),
                "note"   => $params["note"],
...
function register_guestapp_widget() {
    ...
    wp_enqueue_style("font-awesome", "https://netdna.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.css");
    wp_enqueue_script('jquery', 'https://code.jquery.com/jquery-1.11.0.min.js');
    wp_enqueue_script("jquery-touchswipe", "https://cdnjs.cloudflare.com/ajax/libs/jquery.touchswipe/1.6.4/jquery.touchSwipe.js", "jquery");
    wp_enqueue_script("jquery-easing", "https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js", "jquery" );
